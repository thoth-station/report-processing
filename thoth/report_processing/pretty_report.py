...
def create_pretty_report_from_json(report: Dict[Any, Any], is_justification: bool = False) -> str:
    ...
    md += _add_packages_in_advised_pipfile_to_md_report(product=product, is_dev=False)

    # Dev-Packages in Advised Pipfile
    md += _add_packages_in_advised_pipfile_to_md_report(product=product, is_dev=True)
    ...
    md += _add_packages_in_advised_pipfile_lock_to_md_report(product=product, is_dev=False)

    # Dev-Packages in Advised Pipfile.lock
    md += _add_packages_in_advised_pipfile_lock_to_md_report(product=product, is_dev=True)

    # Runtime Environment
    md += _add_runtime_environment_to_md_report(product=product)
